...
<template>
  <nav class="border-r border-slate-300 flex flex-col">
    <section class="p-5 flex flex-col gap-5">
      <AdminMenuLinkGroup title="Каталог">
      ...
      <AdminMenuLink class="text-xl" to="/admin/orders" icon="material-symbols:chrome-reader-mode-outline-rounded" title="Заказы" />
      <AdminMenuLinkGroup title="Спец.предложения">
      ...
      <AdminMenuLink class="text-xl" to="/admin/appeals" icon="material-symbols:person-outline-rounded" title="Обращения" />
    </section>
    <AdminMenuUser />
  </nav>
</template>
